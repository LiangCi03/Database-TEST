...
{
    public class Network_KeyenceBinary : IPlcCommunicationBase
    {


        
        private KeyenceMcNet keyence_net = new KeyenceMcNet();
        ...
        public override int ReadRegisterInt16(string AddressTypeName, uint address)
        {
            ...
            OperateResult<Int16> operateResult = keyence_net.ReadInt16(tempAddress);
        ...
        public override int ReadRegisterInt32(string AddressTypeName, uint address)
        {
            ...
            OperateResult<Int32> operateResult = keyence_net.ReadInt32(AddressTypeName+address.ToString());
            return operateResult.Content;
        }
        ...
        {
            OperateResult<float> operateResult = keyence_net.ReadFloat(AddressTypeName.ToString()+address.ToString());
            return operateResult.Content;
        }
        ...
        public override bool WriterRegisterInt32(string AddressTypeName, uint address, int value)
        {
            ...
            OperateResult operateResult = keyence_net.Write(AddressTypeName+address.ToString(), value);
            if (operateResult.IsSuccess)
            {
                return true;
            }
        ...
        {
            OperateResult operateResult = keyence_net.Write(AddressTypeName.ToString()+address.ToString(), value);
            if (operateResult.IsSuccess)
            {
                return true;
            }
